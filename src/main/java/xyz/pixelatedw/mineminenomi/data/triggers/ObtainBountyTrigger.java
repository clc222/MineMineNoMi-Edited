...
/*    */ 
/*    */ public class ObtainBountyTrigger
/*    */   extends AbstractCriterionTrigger<ObtainBountyTrigger.Instance>
/*    */ {
/* 16 */   private static final ResourceLocation ID = new ResourceLocation("mineminenomi", "obtain_bounty");
/*    */ 
/*    */   
...
/* 25 */     MinMaxBounds.IntBound doriki = MinMaxBounds.IntBound.func_211344_a(pJson.get("bounty"));
...
/* 39 */       super(ObtainBountyTrigger.ID, entityPredicate);
...
/*    */     }
/*    */     
/*    */     public static Instance obtainBounty(int bounty) {
/* 48 */       return new Instance(EntityPredicate.AndPredicate.field_234582_a_, MinMaxBounds.IntBound.func_211340_b(bounty));
/*    */     }
/*    */ 
/*    */     
...
/* 54 */       jsonobject.add("bounty", this.predicate.func_200321_c());
...
/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\data\triggers\ObtainBountyTrigger.class
