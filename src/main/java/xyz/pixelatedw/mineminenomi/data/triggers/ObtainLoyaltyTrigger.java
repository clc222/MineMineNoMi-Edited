...
/*    */ 
/*    */ public class ObtainLoyaltyTrigger
/*    */   extends AbstractCriterionTrigger<ObtainLoyaltyTrigger.Instance>
/*    */ {
/* 16 */   private static final ResourceLocation ID = new ResourceLocation("mineminenomi", "obtain_loyalty");
/*    */ 
/*    */   
...
/* 25 */     MinMaxBounds.IntBound doriki = MinMaxBounds.IntBound.func_211344_a(pJson.get("loyalty"));
...
/* 39 */       super(ObtainLoyaltyTrigger.ID, entityPredicate);
...
/*    */     }
/*    */     
/*    */     public static Instance obtainLoyalty(int loyalty) {
/* 48 */       return new Instance(EntityPredicate.AndPredicate.field_234582_a_, MinMaxBounds.IntBound.func_211340_b(loyalty));
/*    */     }
/*    */ 
/*    */     
...
/* 54 */       jsonobject.add("loyalty", this.predicate.func_200321_c());
...
/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\data\triggers\ObtainLoyaltyTrigger.class
