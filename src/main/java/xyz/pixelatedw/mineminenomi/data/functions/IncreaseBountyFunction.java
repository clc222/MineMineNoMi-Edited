...
/*    */   protected IncreaseBountyFunction(ILootCondition[] conditions, IRandomRange amount, StatChangeSource source) {
...
/* 48 */             amount = (int)(amount * CommonConfig.INSTANCE.getBountyRewardMultiplier());
/*    */           } else {
/*    */             
/* 51 */             amount = 0;
/*    */           } 
...
/*    */       
/* 65 */       boolean hasUpdate = props.alterBounty(amount, this.source);
/*    */       
...
/* 72 */       stack.func_196082_o().func_74768_a("_rewardsBounty", amount);
/*    */     } 
/* 74 */     return stack;
/*    */   }
/*    */ 
...
/* 79 */     return ModLootTypes.INCREASE_BOUNTY;
/*    */   }
/*    */   
...
/*    */   }
/*    */   
/*    */   public static IncreaseBountyFunction create(ILootCondition[] conditions, IRandomRange amount, StatChangeSource source) {
/* 99 */     return new IncreaseBountyFunction(conditions, amount, source);
/*    */   }
/*    */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\data\functions\IncreaseBountyFunction.class
