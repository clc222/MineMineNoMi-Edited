...
/*     */     }
/*     */     
/*  45 */     if (event.getName().equals(((Biome)ModBiomes.RAIGO.get()).getRegistryName()) || event.getName().equals(((Biome)ModBiomes.DRUM.get()).getRegistryName())) {
/*  46 */       return false;
/*     */     }
/*     */     
/*  49 */     if ((event.getClimate()).field_242461_c <= 0.3D || (event.getClimate()).field_242461_c >= 1.5D) {
/*  50 */       return false;
/*     */     }
/*     */     
/*  53 */     boolean canSpawn = CommonConfig.INSTANCE.canSpawnCamps();
/*  54 */     if (!canSpawn) {
/*  55 */       return false;
/*     */     }
/*     */     
...
/*  63 */     return StructuresHelper.StructureFaction.MARINE;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  76 */     boolean isChance = (chunkRandom.nextDouble() * 100.0D < CommonConfig.INSTANCE.getChanceForWatchTowersSpawn());
/*     */     
...
/*     */       
/* 112 */       this.field_75075_a.add(new MarineWatchTowerPiece(templateManager, blockpos, rotation));
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 117 */       func_202500_a();
/*     */       
/* 119 */       StructuresHelper.SPAWNED_STRUCTURES.add(blockpos);
/* 120 */       WyDebug.debug("Marine Watch Tower spawned at: /tp " + (((StructurePiece)this.field_75075_a.get(0)).func_74874_b()).field_78897_a + " ~ " + (((StructurePiece)this.field_75075_a.get(0)).func_74874_b()).field_78896_c);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\watchtower\marine\MarineWatchTowerStructure.class
