...
/*  65 */     return StructuresHelper.StructureFaction.MARINE;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/* 117 */       MarineCampPieces.addComponents(templateManager, blockpos, (Random)this.field_214631_d, this.field_75075_a);
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 122 */       func_202500_a();
/*     */       
/* 124 */       StructuresHelper.SPAWNED_STRUCTURES.add(blockpos);
/* 125 */       WyDebug.debug("Marine Camp spawned at: /tp " + (((StructurePiece)this.field_75075_a.get(0)).func_74874_b()).field_78897_a + " ~ " + (((StructurePiece)this.field_75075_a.get(0)).func_74874_b()).field_78896_c);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\camp\marine\MarineCampStructure.class
