...
/*     */     }
/*     */     
/*  49 */     if ((event.getClimate()).field_242461_c <= 0.0D) {
/*  50 */       return false;
/*     */     }
/*     */     
...
/*     */       
/* 112 */       this.field_75075_a.add(new BlacklegKitchenPiece(templateManager, blockpos, rotation));
/*     */       
/* 114 */       func_202500_a();
/*     */       
/* 116 */       StructuresHelper.SPAWNED_STRUCTURES.add(blockpos);
/* 117 */       WyDebug.debug("Blackleg Kitchen spawned at: /tp " + (((StructurePiece)this.field_75075_a.get(0)).func_74874_b()).field_78897_a + " ~ " + (((StructurePiece)this.field_75075_a.get(0)).func_74874_b()).field_78896_c);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\training\blacklegkitchen\BlacklegKitchenStructure.class
