...
/* 22 */   private static final String TITLE = WyRegistry.registerName("challenge.mineminenomi.arlong", "Arlong");
/* 23 */   public static final String OBJECTIVE = WyRegistry.registerName("challenge.mineminenomi.arlong.objective", "Defeat Arlong");
/* 24 */   public static final ResourceLocation REWARD = new ResourceLocation("mineminenomi", "rewards/arlong");
/*    */   
/* 26 */   public static final ChallengeCore<ArlongChallenge> INSTANCE = (new ChallengeCore.Builder("arlong", TITLE, OBJECTIVE, ModNPCGroups.ARLONG_PIRATES.getName(), ArlongChallenge::new))
...
/* 31 */     .setEnemySpawns(ArlongChallenge::setEnemeySpawns)
/* 32 */     .setTargetShowcase(new Supplier[] { (Supplier)ModEntities.ARLONG
/* 33 */       }).setTimeLimit(10)
/* 34 */     .setOrder(ModChallenges.Order.ARLONG)
...
/*    */     
/* 45 */     ArlongEntity boss = new ArlongEntity(challenge);
...
/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\challenges\arlongpark\ArlongChallenge.class
