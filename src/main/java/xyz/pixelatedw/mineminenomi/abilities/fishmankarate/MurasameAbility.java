...
/* 24 */   private static final ITextComponent[] DESCRIPTION = (ITextComponent[])AbilityHelper.registerDescriptionText("mineminenomi", "murasame", new Pair[] {
/* 25 */         (Pair)ImmutablePair.of("The user fires densely compressed shark-shaped waterbullets at the opponent", null)
/*    */       });
/*    */   
/*    */   private static final float COOLDOWN = 300.0F;
/*    */   private static final float WATER_DAMAGE_MUL = 1.25F;
/* 30 */   public static final AbilityCore<MurasameAbility> INSTANCE = (new AbilityCore.Builder("Murasame", AbilityCategory.RACIAL, MurasameAbility::new))
/* 31 */     .addDescriptionLine(DESCRIPTION)
/* 32 */     .addAdvancedDescriptionLine(new AbilityDescriptionLine.IDescriptionLine[] { AbilityDescriptionLine.NEW_LINE, CooldownComponent.getTooltip(300.0F), FishmanKarateHelper.getWaterBuffedProjectileDamageStat(1.25F)
/* 33 */       }).setSourceHakiNature(SourceHakiNature.IMBUING)
/* 34 */     .setSourceElement(SourceElement.WATER)
/* 35 */     .setUnlockCheck(MurasameAbility::canUnlock)
/* 36 */     .build();
/*    */   
...
/*    */   
/*    */   public MurasameAbility(AbilityCore<MurasameAbility> core) {
/* 43 */     super(core);
/*    */     
/* 45 */     this.isNew = true;
...
/* 60 */     this.repeaterComponent.start(entity, 5, 3);
/*    */   }
/*    */   
/*    */   private void onRepeaterTriggerEvent(LivingEntity entity, IAbility ability) {
/* 64 */     this.projectileComponent.shoot(entity, 3.0F, 1.0F);
/*    */   }
/*    */   
/*    */   private void onRepeaterStopEvent(LivingEntity entity, IAbility ability) {
/* 68 */     this.continuousComponent.stopContinuity(entity);
/* 69 */     this.cooldownComponent.startCooldown(entity, 300.0F);
/*    */   }
/*    */   
/*    */   private MurasameProjectile createProjectile(LivingEntity entity) {
/* 73 */     MurasameProjectile proj = new MurasameProjectile(entity.field_70170_p, entity);
/* 74 */     if (FishmanKarateHelper.isInWater(entity)) {
/* 75 */       proj.setDamage(proj.getDamage() * 1.25F);
/*    */     }
/* 77 */     return proj;
/*    */   }
/*    */   
...
/* 82 */     return (props.isFishman() && props.getDoriki() >= 5000.0D);
/*    */   }
/*    */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\abilities\fishmankarate\MurasameAbility.class
