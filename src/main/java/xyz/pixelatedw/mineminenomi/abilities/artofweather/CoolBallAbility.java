...
/* 27 */   private static final ITextComponent[] DESCRIPTION = (ITextComponent[])AbilityHelper.registerDescriptionText("mineminenomi", "cool_ball", new Pair[] {
/* 28 */         (Pair)ImmutablePair.of("Launch a Cool Ball from your Clima Tact to use for different Tempos", null), 
/* 29 */         (Pair)ImmutablePair.of("§aSHIFT-USE§r: Loads the ball into the clima tact", null)
/*    */       });
/* 31 */   public static final AbilityCore<CoolBallAbility> INSTANCE = (new AbilityCore.Builder("Cool Ball", AbilityCategory.STYLE, CoolBallAbility::new))
/* 32 */     .addDescriptionLine(DESCRIPTION)
/* 33 */     .setSourceElement(SourceElement.ICE)
/* 34 */     .setSourceHakiNature(SourceHakiNature.IMBUING)
/* 35 */     .setUnlockCheck(CoolBallAbility::canUnlock)
/* 36 */     .build();
/*    */   
...
/* 46 */     return WeatherBallKind.COOL;
/*    */   }
/*    */ 
/*    */   
/*    */   public ParticleEffect<?> getParticleEffect() {
/* 51 */     return (ParticleEffect)ModParticleEffects.COOL_BALL_CHARGE.get();
/*    */   }
/*    */ 
/*    */   
/*    */   public WeatherBallProjectile getWeatherBallEntity(LivingEntity entity, EntityRayTraceResult lookTrace) {
/* 56 */     CoolBallProjectile proj = new CoolBallProjectile(entity.field_70170_p, entity, INSTANCE);
...
/*    */     
/* 71 */     return (props.isWeatherWizard() && questProps.hasFinishedQuest(ModQuests.ART_OF_WEATHER_TRIAL_01));
/*    */   }
/*    */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\abilities\artofweather\CoolBallAbility.class
