...
/*  15 */     .addStartEvent(90, this::startContinuityEvent)
/*  16 */     .addTickEvent(90, this::tickContinuityEvent)
/*  17 */     .addEndEvent(90, this::endContinuityEvent);
...
/*  36 */     this.continuousComponent.triggerContinuity(entity);
/*     */   }
/*     */   
...
/*  81 */     if (!this.hasFallDamage && damageSource == DamageSource.field_76379_h) {
/*  82 */       this.hasFallDamage = true;
/*  83 */       return 0.0F;
/*     */     } 
/*     */     
/*  86 */     return damage;
...
/*  91 */     nbt = super.save(nbt);
/*  92 */     nbt.func_74757_a("hasFallDamage", this.hasFallDamage);
/*  93 */     return nbt;
/*     */   }
/*     */ 
/*     */   
...
/*  98 */     super.load(nbt);
/*  99 */     this.hasFallDamage = nbt.func_74767_n("hasFallDamage");
/*     */   }
/*     */   
/*     */   public void setLanded() {
/* 103 */     this.hasLanded = true;
/*     */   }
/*     */   
/*     */   public boolean hasLanded() {
/* 107 */     return this.hasLanded;
/*     */   }
/*     */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\api\abilities\DropHitAbility2.class
