...
/*    */         
/* 32 */         double motionX = x / 7.0D;
/* 33 */         double motionY = 0.02D + rand.nextDouble() / 10.0D;
/* 34 */         double motionZ = z / 7.0D;
/*    */         
...
/* 40 */         world.func_195590_a((IParticleData)data, true, posX + x * 1.65D + WyHelper.randomDouble(), posY + y, posZ + z * 1.65D + WyHelper.randomDouble(), 0.0D, 0.0D, 0.0D);
/*    */       } 
/*    */     } 
/*    */   }
/*    */ }
...
/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\particles\effects\moku\WhiteStrikeParticleEffect.class
