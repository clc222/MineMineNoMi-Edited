...
/*    */ 
/*    */ public class BonChariItem extends Item {
...
/* 52 */       BonChariEntity bonChari = new BonChariEntity(level);
/* 53 */       bonChari.func_70107_b((blockRayTraceResult.func_216347_e()).field_72450_a, (blockRayTraceResult.func_216347_e()).field_72448_b, (blockRayTraceResult.func_216347_e()).field_72449_c);
/* 54 */       bonChari.field_70177_z = player.field_70177_z;
/* 55 */       if (!level.func_226665_a__((Entity)bonChari, bonChari.func_174813_aQ().func_186662_g(-0.1D))) {
/* 56 */         return ActionResult.func_226251_d_(heldItem);
/*    */       }
/*    */       
/* 59 */       if (!level.field_72995_K) {
/* 60 */         level.func_217376_c((Entity)bonChari);
...
/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\items\BonChariItem.class
