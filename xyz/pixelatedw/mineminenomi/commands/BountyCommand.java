...
/* 29 */     LiteralArgumentBuilder<CommandSource> builder = (LiteralArgumentBuilder<CommandSource>)Commands.func_197057_a("bounty").requires(Requires.hasPermission(2, WyPermissions.BOUNTY_COMMAND));
/*    */     
/* 31 */     builder
/* 32 */       .then(((RequiredArgumentBuilder)Commands.func_197056_a("amount", (ArgumentType)LongArgumentType.longArg(-100000000000L, 100000000000L))
/* 33 */         .executes(context -> alterBounty(context, LongArgumentType.getLong(context, "amount"), getDefaultCollection(context))))
/* 34 */         .then(Commands.func_197056_a("targets", (ArgumentType)EntityArgument.func_197094_d())
/* 35 */           .executes(context -> alterBounty(context, LongArgumentType.getLong(context, "amount"), EntityArgument.func_197090_e(context, "targets")))));
/*    */     
...
/*    */       
/* 54 */       if (entityStatsProps.alterBounty(amount, StatChangeSource.COMMAND)) {
/*    */         
/* 56 */         WyNetwork.sendTo(new SSyncEntityStatsPacket(player.func_145782_y(), entityStatsProps), (PlayerEntity)player);
/* 57 */         ((CommandSource)context.getSource()).func_197030_a((ITextComponent)new StringTextComponent(TextFormatting.GREEN + "" + ((amount > 0L) ? "+" : "") + amount + " bounty for " + player.func_145748_c_().getString()), true);
/*    */       } 
/*    */     } 
/*    */     
/* 61 */     return 1;
...
/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\commands\BountyCommand.class
