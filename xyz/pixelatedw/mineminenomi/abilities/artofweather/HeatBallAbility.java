...
/* 27 */   private static final ITextComponent[] DESCRIPTION = (ITextComponent[])AbilityHelper.registerDescriptionText("mineminenomi", "heat_ball", new Pair[] {
/* 28 */         (Pair)ImmutablePair.of("Launch a Heat Ball from your Clima Tact to use for different Tempos", null), 
/* 29 */         (Pair)ImmutablePair.of("§aSHIFT-USE§r: Loads the ball into the clima tact", null)
/*    */       });
/* 31 */   public static final AbilityCore<HeatBallAbility> INSTANCE = (new AbilityCore.Builder("Heat Ball", AbilityCategory.STYLE, HeatBallAbility::new))
/* 32 */     .addDescriptionLine(DESCRIPTION)
/* 33 */     .setSourceElement(SourceElement.FIRE)
/* 34 */     .setSourceHakiNature(SourceHakiNature.IMBUING)
/* 35 */     .setUnlockCheck(HeatBallAbility::canUnlock)
/* 36 */     .build();
/*    */   
...
/* 46 */     return WeatherBallKind.HEAT;
/*    */   }
/*    */ 
/*    */   
/*    */   public ParticleEffect<?> getParticleEffect() {
/* 51 */     return (ParticleEffect)ModParticleEffects.HEAT_BALL_CHARGE.get();
/*    */   }
/*    */ 
/*    */   
/*    */   public WeatherBallProjectile getWeatherBallEntity(LivingEntity entity, EntityRayTraceResult lookTrace) {
/* 56 */     HeatBallProjectile proj = new HeatBallProjectile(entity.field_70170_p, entity, INSTANCE);
...
/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\abilities\artofweather\HeatBallAbility.class
