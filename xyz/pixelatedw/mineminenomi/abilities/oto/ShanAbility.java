...
/* 35 */   private static final ITextComponent[] DESCRIPTION = (ITextComponent[])AbilityHelper.registerDescriptionText("mineminenomi", "shan", new Pair[] {
/* 36 */         (Pair)ImmutablePair.of("The user turns their head into a cymbal, by pushing their own head they create a sound shockwave powerful enough to internally cut any entity hearing it", null)
/*    */       });
/*    */   
...
/* 45 */   public static final AbilityCore<ShanAbility> INSTANCE = (new AbilityCore.Builder("Shan", AbilityCategory.DEVIL_FRUITS, ShanAbility::new))
...
/* 68 */     entity.field_70170_p.func_184133_a(null, entity.func_233580_cy_(), (SoundEvent)ModSounds.SHAN.get(), SoundCategory.PLAYERS, 3.0F, 0.2F + entity.func_70681_au().nextFloat());
/*    */     
/* 70 */     List<LivingEntity> targets = this.rangeComponent.getTargetsInLine(entity, 24.0F, 3.0F);
/*    */     
/* 72 */     this.animationComponent.start(entity, ModAnimations.SHAN, 20);
/*    */     
...
/* 86 */         target.func_195064_c(new EffectInstance((Effect)ModEffects.BLEEDING.get(), 100, 0));
/*    */         
/* 88 */         for (int i = 0; i < 5; i++) {
/* 89 */           double offsetX = target.func_70681_au().nextDouble() / 2.0D;
/* 90 */           double offsetZ = target.func_70681_au().nextDouble() / 2.0D;
/*    */           
/* 92 */           WyHelper.spawnParticles((IParticleData)ParticleTypes.field_197603_N, (ServerWorld)entity.field_70170_p, target.func_226277_ct_() + offsetX, target.func_226278_cu_() + target.func_70047_e() + offsetX, target.func_226281_cx_() + offsetZ);
/*    */         } 
/*    */         
/*    */         break;
/*    */       } 
/*    */     } 
/*    */     
/* 99 */     this.cooldownComponent.startCooldown(entity, 60.0F);
/*    */   }
/*    */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\abilities\oto\ShanAbility.class
