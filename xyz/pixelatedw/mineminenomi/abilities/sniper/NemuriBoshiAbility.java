...
/* 28 */   private static final ITextComponent[] DESCRIPTION = (ITextComponent[])AbilityHelper.registerDescriptionText("mineminenomi", "nemuri_boshi", new Pair[] {
/* 29 */         (Pair)ImmutablePair.of("Fires a pellet, that puts the enemy to sleep for a few seconds", null)
/*    */       });
/*    */   
/*    */   private static final float COOLDOWN = 400.0F;
/* 33 */   public static final AbilityCore<NemuriBoshiAbility> INSTANCE = (new AbilityCore.Builder("Nemuri Boshi", AbilityCategory.STYLE, NemuriBoshiAbility::new))
/* 34 */     .addDescriptionLine(DESCRIPTION)
/* 35 */     .addAdvancedDescriptionLine(new AbilityDescriptionLine.IDescriptionLine[] { AbilityDescriptionLine.NEW_LINE, CooldownComponent.getTooltip(400.0F), ContinuousComponent.getTooltip()
...
/* 39 */       }).setUnlockCheck(NemuriBoshiAbility::canUnlock)
/* 40 */     .build();
/*    */   
...
/* 63 */       this.projectileComponent.shoot(entity, 5.0F, 1.0F);
/* 64 */       this.continuousComponent.stopContinuity(entity);
/* 65 */       this.cooldownComponent.startCooldown(entity, 400.0F);
/* 66 */       return true;
/*    */     } 
/* 68 */     return false;
/*    */   }
...
/* 72 */     NemuriBoshiProjectile proj = new NemuriBoshiProjectile(entity.field_70170_p, entity);
/* 73 */     return proj;
/*    */   }
/*    */   
...
/*    */     
/* 85 */     return (props.isSniper() && questProps.hasFinishedQuest(ModQuests.SNIPER_TRIAL_05));
/*    */   }
/*    */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\abilities\sniper\NemuriBoshiAbility.class
