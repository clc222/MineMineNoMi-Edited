...
/* 28 */   private static final ITextComponent[] DESCRIPTION = (ITextComponent[])AbilityHelper.registerDescriptionText("mineminenomi", "tetsu_boshi", new Pair[] {
/* 29 */         (Pair)ImmutablePair.of("Fires a pellet that upon impact releases multiple small iron spikes on the ground", null)
/*    */       });
/*    */   
/*    */   private static final float COOLDOWN = 140.0F;
/* 33 */   public static final AbilityCore<TetsuBoshiAbility> INSTANCE = (new AbilityCore.Builder("Tetsu Boshi", AbilityCategory.STYLE, TetsuBoshiAbility::new))
...
/* 39 */       }).setUnlockCheck(TetsuBoshiAbility::canUnlock)
/* 40 */     .build();
/*    */   
...
/* 63 */       this.projectileComponent.shoot(entity, 4.0F, 0.5F);
...
/* 72 */     TetsuBoshiProjectile proj = new TetsuBoshiProjectile(entity.field_70170_p, entity);
/* 73 */     return proj;
/*    */   }
/*    */   
...
/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\abilities\sniper\TetsuBoshiAbility.class
