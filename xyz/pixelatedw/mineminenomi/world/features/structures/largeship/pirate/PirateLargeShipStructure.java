...
/*     */       
/* 103 */       this.field_75075_a.add(new PirateLargeShipPiece(templateManager, blockpos, rotation));
/*     */       
/* 105 */       this.field_75075_a.forEach(piece -> piece.func_181138_a(0, -10, 0));
/* 106 */       this.field_75075_a.forEach(piece -> (piece.func_74874_b()).field_78895_b -= 10);
/*     */       
/* 108 */       func_202500_a();
/*     */       
/* 110 */       StructuresHelper.SPAWNED_STRUCTURES.add(blockpos);
/* 111 */       WyDebug.debug("Pirate Large Ship spawned at: /tp " + (((StructurePiece)this.field_75075_a.get(0)).func_74874_b()).field_78897_a + " ~ " + (((StructurePiece)this.field_75075_a.get(0)).func_74874_b()).field_78896_c);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\largeship\pirate\PirateLargeShipStructure.class
