...
/*     */ {
/*  34 */   private static final ResourceLocation SMALL_TENT = new ResourceLocation("mineminenomi", "marine/small_tent");
/*  35 */   private static final ResourceLocation LARGE_TENT = new ResourceLocation("mineminenomi", "marine/large_tent");
...
/*  92 */       super(ModStructures.Pieces.MARINE_CAMP_PIECE, nbt);
...
/* 101 */       super(ModStructures.Pieces.MARINE_CAMP_PIECE, 0);
...
/* 120 */       PlacementSettings placementsettings = (new PlacementSettings()).func_186220_a(this.rotation).func_186214_a(Mirror.NONE).func_207665_a((BlockPos)MarineCampPieces.CENTER_OFFSET.get(this.resourceLocation)).func_215222_a(this.processor);
...
/* 129 */         StructuresHelper.spawnLoot((IWorld)world, pos, ModLootTables.MARINE_CAMP_SMALL_TENT_CHEST);
/*     */       }
/* 131 */       if (function.equals("large_tent_chest")) {
/* 132 */         StructuresHelper.spawnLoot((IWorld)world, pos, ModLootTables.MARINE_CAMP_LARGE_TENT_CHEST);
/*     */       }
/*     */       
/* 135 */       if (function.equals("small_tent_spawn")) {
/* 136 */         StructuresHelper.spawnMobs((IWorld)world, pos, StructuresHelper.StructureFaction.MARINE, StructuresHelper.StructureSpawnType.GRUNT, 2);
/*     */       }
/* 138 */       if (function.equals("large_tent_spawn"))
/* 139 */         StructuresHelper.spawnMobs((IWorld)world, pos, StructuresHelper.StructureFaction.MARINE, StructuresHelper.StructureSpawnType.CAPTAIN, 2); 
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\camp\marine\MarineCampPieces.class
