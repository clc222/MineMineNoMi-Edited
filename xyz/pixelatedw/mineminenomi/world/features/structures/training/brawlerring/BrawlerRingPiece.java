...
/* 31 */     super(ModStructures.Pieces.BRAWLER_RING_PIECE, nbt);
...
/* 39 */     super(ModStructures.Pieces.BRAWLER_RING_PIECE, 0);
/* 40 */     this.field_186178_c = pos;
/* 41 */     this.rotation = rot;
/* 42 */     this.resourceLocation = new ResourceLocation("mineminenomi", "unaligned/brawler_ring");
/* 43 */     build(template);
/*    */   }
/*    */ 
/*    */ 
...
/* 71 */         ((CustomSpawnerTileEntity)spawner).setSpawnerMob((EntityType)ModEntities.BRAWLER_TRAINER.get());
/*    */       } 
/*    */     } 
/*    */   }
/*    */ }
...
/* Location:              C:\Users\herrc\Downloads\mine-mine-no-mi-1.16.5-0.10.8.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\training\brawlerring\BrawlerRingPiece.class
